...
import devsystem.olimpiclink.databinding.ActivityLeaderComunityBinding
...
class LeaderComunityActivity : AppCompatActivity() {
    private lateinit var binding : ActivityLeaderComunityBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityLeaderComunityBinding.inflate(layoutInflater)
    ...
    private fun publicationGet() {
        lifecycleScope.launch {
            try {
                ...
                val adapter = AdapterPublication(list_publication, this@LeaderComunityActivity, user)
                val rc = binding.rcFeed
                rc.layoutManager = LinearLayoutManager(this@LeaderComunityActivity)
    ...
    fun showEvents(view: View) {
        ...
        lifecycleScope.launch {
            try {
                ...
                val adapter = AdapterEvent(this@LeaderComunityActivity, user, list_events)
